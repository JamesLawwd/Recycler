...
class SingleActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val prefs:SharedPreferences = getSharedPreferences("productBD", Context.MODE_PRIVATE)
        ...
        val cost = findViewById<TextView>(R.id.productCost)
        ...
        payBtn.setOnClickListener {
            ...
            client.post(this,"http://jameskinyanjui.pythonanywhere.com/payment", body, "application/json",
                ...
                object :JsonHttpResponseHandler() {
                    ...
                    override fun onSuccess(
                        ...
                        Toast.makeText(applicationContext, "Please Complete Payment on Your Phone$statusCode", Toast.LENGTH_LONG).show()
